package com.learning.rxjava.connectable;
...
public class ObserveOnConnectableExample {
	...
	public static void main(String[] args) {
		...
		connectable
				// We want to run this on a different thread than the ticker
				// thread
				.observeOn(Schedulers.computation()).subscribe((t) -> {
		...
		// Now we call "connect" on the connectable observable...and things
		// start happening...
